...
from training.order_classification_loss import OrderClassificationLoss
from training.lightning_module import LightningModule


class OrderClassificationInstance(LightningModule):
    def __init__(
        self,
        network: nn.Module,
        ...
        occlusion_coefficient: float = 3.0,  # InstaOrder
        depth_coefficient: float = 3.0,  # InstaOrder
        ...
        self.criterion = OrderClassificationLoss(
    ...
    def eval_step(
        ...
        mask_logits_per_layer, class_logits_per_layer, occ_logits, depth_logits = self(
            transformed_imgs
        )
